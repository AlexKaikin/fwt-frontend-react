...
const Pagination = props => {
    ...
    return  <div className='pagination'>
                <button onClick={() => props.currentPageChange(1)} className='page' disabled={currentPage === 1} >
                ...
                <button onClick={() => props.currentPageChange(currentPage - 1)} className='page' disabled={currentPage === 1}>
                ...
                <button onClick={() => props.currentPageChange(currentPage + 1)} className='page' disabled={currentPage === pagesCount}>
                    <svg width="9" height="13" viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button onClick={() => props.currentPageChange(pagesCount)} className='page' disabled={currentPage === pagesCount}>
                    <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
